...
public class Primes {
	...
	public ArrayList<BigInteger> getPrimeList() {
        return primeList;
    }
	...
	// Count the number of digits in a BigInteger
	...
	public Pair<Integer> sizeofLastCross()
	{
	    ...
	    int ldigit = countDigits(lastPair.left());
	    int rdigit = countDigits(lastPair.right());
	    Pair<Integer> digitPair = new Pair<Integer>(ldigit, rdigit);
	    return digitPair;
	}
