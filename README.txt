...
How to run my code: 
Load Prime: Click the button Load Prime and statistics of prime number will show up, and all the prime numbers loaded will be stored into the prime list.
...
Load Cross: Click the button Load Cross and statistics of hexadecimal number will show up, and all the hexadecimal numbers loaded will be stored into the cross list.
